...
struct PlayerPhysicsOverride
{
	...
	// Raise collision-box bottom by this many nodes so the player can sink into
	// a floor portal past blocking blocks below the portal frame.  Zero = disabled.
	float floor_portal_cb_shift = 0.f;
