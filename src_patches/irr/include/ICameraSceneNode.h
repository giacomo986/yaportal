...
public:
	...
	*/
	...
	//! Override the projection matrix used for rendering (driver ETS_PROJECTION)
	//! without affecting the view frustum used for CPU-side scene culling.
	//! The frustum continues to use the matrix set via setProjectionMatrix /
	//! setNearValue / setFOV etc. Call clearRenderProjectionMatrix() to revert.
